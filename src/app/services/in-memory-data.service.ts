    ...
    const projects = [
      {
        ...
        url: '<a href="https://lxp-cbgflower.vercel.app" rel="noopener noreferrer" target="_blank">https://lxp-cbgflower.vercel.app</a>',
        skills: [
          'React/Next.js',
          'Tailwind CSS',
          'Sanity CMS',
        ...
        blurb:
          'Frontend for cannabis education company site Green Flower (green-flower.com). This iteration of the site was built from scratch based on Adobe XD mockups and style guides, using a custom React component library.',
        bullets: [
      ...
      },
      {
        ...
        images: [
          {
            id: 1,
            caption: 'NFT Market > Homepage',
          },
          {
            id: 2,
            caption: 'NFT Market > NFT view',
          },
          {
            id: 3,
            caption: 'NFT Market > Collection view',
          },
        ],
        blurb:
          'Basic NFT marketplace frontend developed over two days as a personal challenge. Users can browse any Ethereum NFT collection and view the NFT holdings of any Ethereum wallet.',
        bullets: [
          'Uses Moralis SDK (moralis.io) to fetch NFT data.',
          'Uses web3-react for wallet connect functionality',
        ],
      },
      {
        id: 11,
      ...
      },
      {
        ...
        url: '<a href="https://rta-dubai-1900a.web.app" target="_blank">https://rta-dubai-1900a.web.app</a>',
        skills: [
          'Angular',
          'Angular Material',
          'ArcGIS',
      ...
      },
      {
        ...
        slug: 'nextkeycloak',
        title: 'Next Keycloak',
        url: '<a href="https://github.com/jplew/next-keycloak" target="_blank" rel="noopener noreferrer">https://github.com/jplew/next-keycloak</a>',
